...
import com.derigible.data.structure.abstracts.Map;
import com.derigible.data.structure.abstracts.MapNode;
import com.derigible.data.structure.queue.ListMinPriorityQueue;
import com.derigible.data.structure.stackbag.ListStack;
...
public class ListHashTable <K extends Comparable<K>, E> implements Map<K,E>{
	...
	private Node<K,E>[] table = new Node[buckets];
	...
	@Override
	/**
	 * This method does not do anything. Only here to meet the demands of the iterator class. Use the remove(K key) instead.
	 *
	 */
	public void remove() {
	}
